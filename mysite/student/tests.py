...
class TestViews (TestCase):
    ...
    def test_behavioural_view(self):
        behavioural = reverse('student:behavioural', kwargs={'slug': 'ecm3442'})
    ...
    def test_cognitive_view(self):
        cognitive = reverse('student:cognitive', kwargs={'slug': 'ecm3442'})
    ...
    def test_affective_view(self):
        affective = reverse('student:affective', kwargs={'slug': 'ecm3442'})
    ...
    def test_404_on_nonexistent_module(self):
        response = self.client.get(reverse('student:behavioural', args=['nonexistent-module']))
        self.assertEqual(response.status_code, 404)

class TestForms(TestCase):

    def test_affectiveForm_data(self):
        form = AffectiveForm(data={
            'emoji': '1',
            'text': 'test',
        })
